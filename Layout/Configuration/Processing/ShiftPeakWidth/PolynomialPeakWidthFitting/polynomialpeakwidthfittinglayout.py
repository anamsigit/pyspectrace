...
class PolynomialPeakWidthFittingLayout(QWidget):
    ...
    def show_dialog(self):
        self.dialog = QWidget()
        self.dialog.setWindowTitle("Polynomial Peak Width Fitting")
        self.setupTableFitting(self.dialog)
        self.dialog.resize(910, 300)
        self.dialog.show()
    ...
    def setupTableFitting(self, dialog):
        ...
        self.table_widget.setHorizontalHeaderLabels(['Init center (nm)', '-Δ λ (nm)', '+Δ λ (nm)', 'Descriptor', 'Order', 'Transform', 'Auto', 'Label', 'Color'])
    ...
    def populate_table(self, table_widget):
        ...
        for i in range(len(self.num_fitting)):
            ...
            table_widget.setCellWidget(i, 3, method)
            ...
            table_widget.setCellWidget(i, 4, function_orde)
