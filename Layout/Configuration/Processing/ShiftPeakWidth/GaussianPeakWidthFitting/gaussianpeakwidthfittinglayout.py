...
from PyQt5.QtWidgets import (QWidget, QVBoxLayout, 
    QHBoxLayout, QPushButton,QCheckBox, QComboBox, QGroupBox, QLineEdit,  QTableWidget,
    QColorDialog)

class GaussianPeakWidthFittingLayout(QWidget):
    ...
    def show_dialog(self):
        self.dialog = QWidget()
        self.dialog.setWindowTitle("Gaussian Peak Width Fitting")
    ...
    def setupTableFitting(self, dialog):
        ...
        self.table_widget.setHorizontalHeaderLabels(['Init center (nm)', '-Δ λ (nm)', '+Δ λ (nm)', 'Descriptor', 'Transform', 'Auto', 'Label', 'Color'])
    ...
    def populate_table(self, table_widget):
        ...
        for i in range(len(self.num_fitting)):
            ...
            table_widget.setCellWidget(i, 4, transform)
            ...
            table_widget.setCellWidget(i, 5, inverse)
