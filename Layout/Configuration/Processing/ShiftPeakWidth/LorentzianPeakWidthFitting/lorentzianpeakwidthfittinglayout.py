...
from PyQt5.QtWidgets import ( QWidget, QVBoxLayout, 
    QHBoxLayout, QPushButton,QCheckBox, QComboBox, QGroupBox, QLineEdit, QFormLayout, QTableWidget,
    QColorDialog
)

class LorentzianPeakWidthFittingLayout(QWidget):
    ...
    def show_dialog(self):
        self.dialog = QWidget()
        self.dialog.setWindowTitle("Lorentzian Peak Width Fitting")
