...
class GaussianPeakFittingControl:
    def __init__(self, model, view):
        ...
        self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.min_values = [f"{self.model.wavelengths[0 + 1]:.2f}"]
        self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.max_values = [f"{self.model.wavelengths[-1 - 1]:.2f}"]
    ...
    def mainloop(self):
        self.acquire()
        if self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.dialog_open:
            self.num_fitting = copy.deepcopy(self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.num_fitting)
            self.num_shiftpeak = copy.deepcopy(self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.num_shiftpeak)
            self.center_func_time = copy.deepcopy(self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.initial_center_values)
            self.min_values = copy.deepcopy(self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.min_values)
            self.max_values = copy.deepcopy(self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.max_values)
            self.method_selected = copy.deepcopy(self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.method_selected)
            self.inverse_axis = copy.deepcopy(self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.axis_selected)
            self.transform_selected = copy.deepcopy(self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.transform_selected)
            self.status_inverse = copy.deepcopy(self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.status_inverse)
            ...
            self.view.plottinglayout.spectrumlayout.name_gaussianpeakfitting = self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.name_values
            self.view.plottinglayout.sensorgramlayout.name_gaussianpeakfitting = self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.name_values
            
            self.view.plottinglayout.spectrumlayout.color_gaussianshiftpeak = self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.color_values
            self.view.plottinglayout.spectrumlayout.color_gaussianpeakfitting = self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.color_values
            
            self.view.plottinglayout.sensorgramlayout.color_gaussianshiftpeak = self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.color_values
        ...
        if self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.dialog_open:
            ...
            self.view.configurationlayout.processinglayout.shiftpeaklayout.gaussianpeakfittinglayout.dialog_open = False
    ...
    def fitting(self):
        ...
        self.view.plottinglayout.spectrumlayout.num_gaussianpeakfitting = self.num_fitting
        self.view.plottinglayout.spectrumlayout.plot_gaussianpeakfitting(cumulative_plot_fitting, cumulative_plot_fitting)
                
        self.view.plottinglayout.spectrumlayout.num_gaussianshiftpeak = self.num_shiftpeak
        self.view.plottinglayout.spectrumlayout.plot_gaussianshiftpeak(self.inverse_axis, cumulative_plot_shiftpeak, cumulative_plot_shiftpeak)   
            
        self.view.plottinglayout.sensorgramlayout.num_gaussianshiftpeak = self.num_shiftpeak
        self.view.plottinglayout.sensorgramlayout.plot_gaussianshiftpeak(self.transform_selected, cumulative_plot_shiftpeak, cumulative_plot_shiftpeak)  
